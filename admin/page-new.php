...
if (isset($_GET["action"])) {
	...
	if($url == "add") { 
		...
		VALUES ('$post_title','$post_content' , 'page', '0')";

		if ($conn->query($sql) === TRUE) {
			
    	$alert = '<div class="ac-alert" role="alert">
    				<p>Page was added successfully!</p>
					<br>
					<p><strong>You will be redirect after 2 seconds!</strong></p>
					</div>';
		header( "refresh:2;url=page-new.php" );	
...
<head>
    ...
    <title>AdminConsole CORE Add new page</title>
...
<body>
    ...
    <div id="ac-content">
		...
		<div class="row">
		<div class="col-md-8">
		<form id="pageForm" action="page-new.php?action=add" method="post">
