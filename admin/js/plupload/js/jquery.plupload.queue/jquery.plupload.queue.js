							...
							'<div class="plupload_filelist_footer">' +
								'<div class="plupload_file_name">' +
									'<div class="plupload_buttons">' +
										'<a href="#" class="plupload_button plupload_add" id="' + id + '_browse"><i class="fas fa-plus-circle"></i>  ' + _('Add Files') + '</a>' +
										'<a href="#" class="plupload_button plupload_start"><i class="fas fa-upload"></i>  ' + _('Start Upload') + '</a>' +
									'</div>' +
