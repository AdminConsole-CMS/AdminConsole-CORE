            ...
            <div class="container-fluid"><a id="sidebar-collapse" class="navbar-collapse-icon"><i class="fas fa-arrow-left"></i></a>
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false"><img src="img/ac1.png">&nbsp;<?php if (isset($_SESSION['username'])) {echo $_SESSION['username'];} ?></a>
